  ...
  return (
    ...
    >
      ...
      <div className="mt-10 max-w-[820px] rounded-2xl bg-black/20 p-5 ring-1 ring-white/8 backdrop-blur-md sm:p-6">
        <h3 className="text-sm font-semibold text-[#f6f4f2] mb-4">
          Visión de Futuro: Circuito Nacional
        </h3>

        <p className="text-[13px] leading-[1.7] text-[#8f8a87] mb-4">
          Este evento es el pilar para consolidar a Paraná en el mapa de las
          aguas abiertas. Nuestra meta es la homologación federal para que la
          “Vuelta al Islote Curupí” integre el calendario de la Confederación
          Argentina de Deportes Acuáticos (CADDA), atrayendo a la élite de la
          natación argentina a nuestra provincia.
        </p>

        <h3 className="text-sm font-semibold text-[#f6f4f2] mb-3 mt-6">
        ...
        <ul className="space-y-3 text-[13px] leading-[1.7] text-[#8f8a87]">
          ...
          <li>
            • Se requiere cumplir indicaciones de organización y seguridad.
          </li>
          <li>
            • El participante declara encontrarse en condiciones físicas y de
            salud aptas para realizar la actividad.
          </li>
          <li>
            • Acepta los riesgos inherentes a un evento acuático y se compromete
            a respetar el reglamento, las zonas marcadas y las indicaciones del
            personal.
          </li>
          <li>
        ...
        <Accordion
          ...
          contentClassName="mt-4 space-y-3 text-[13px] leading-[1.75] text-[#8f8a87]"
        >
          <p>
            El participante declara encontrarse en condiciones físicas y de
